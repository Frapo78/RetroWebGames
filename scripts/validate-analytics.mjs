...
for (const marker of ["track('leaderboard_view'", "track('leaderboard_home_top3'", "track('leaderboard_home_retry'", "track('leaderboard_pause_view'", "track('leaderboard_entry_view'", "track('leaderboard_auto_submit_start'", "'leaderboard_auto_submit'", "'leaderboard_name_saved'", "track('leaderboard_rank_card_view'", "track('leaderboard_submit_error'", "track('leaderboard_submit_queued'", "track('leaderboard_queue_flush'", "track('post_score'"]) {
