...
for dir in scripts docs server ops src astro-poc astro-site; do
  cp -al "${ROOT}/${dir}" "${TREE}/"
done
cp -a "${ROOT}/AGENTS.md" "${ROOT}/README.md" "${ROOT}/TODO.md" "${ROOT}/astro.config.mjs" "${ROOT}/package.json" "${ROOT}/package-lock.json" "${TREE}/"
