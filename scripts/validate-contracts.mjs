...
for (const rel of ['scripts/validate-session.mjs','scripts/validate-bubble-burst.mjs','scripts/validate-solitaire.mjs','scripts/validate-prism-breaker.mjs','scripts/validate-social-sharing.mjs']) {
...
console.log('  ✓ Session, social sharing, Bubble Burst, Solitario and Prism Breaker specialized validators are green');
