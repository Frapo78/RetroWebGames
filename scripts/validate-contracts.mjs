...
for (const rel of ['scripts/validate-session.mjs','scripts/validate-avatar.mjs','scripts/validate-block-drop.mjs','scripts/validate-bubble-burst.mjs','scripts/validate-solitaire.mjs','scripts/validate-neon-snake.mjs','scripts/validate-prism-breaker.mjs','scripts/validate-the-great-empire.mjs','scripts/validate-shared-controls.mjs','scripts/validate-social-sharing.mjs','scripts/validate-analytics.mjs','scripts/validate-icons.mjs','scripts/validate-pwa-install.mjs','scripts/validate-lazy-images.mjs','scripts/validate-seo-geo.mjs','scripts/validate-leaderboards.mjs','scripts/validate-security.mjs','scripts/validate-partners.mjs','scripts/validate-i18n.mjs']) {
