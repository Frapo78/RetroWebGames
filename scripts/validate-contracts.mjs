...
const terminalRuntimes = [
  ...
  ['The Great Empire', 'games/the-great-empire/game.js']
];
const continueRuntimes = [
  'games/star-swarm/engine.js','games/bubble-burst/game.js','games/block-drop/game.js','games/maze-munch/game.js','games/neon-rally/game.js','games/neon-snake/game.js','games/neon-tilt/game.js','games/prism-breaker/engine.js','games/the-great-empire/game.js'
];
...
for (const rel of ['scripts/validate-session.mjs','scripts/validate-avatar.mjs','scripts/validate-block-drop.mjs','scripts/validate-bubble-burst.mjs','scripts/validate-solitaire.mjs','scripts/validate-neon-snake.mjs','scripts/validate-neon-tilt.mjs','scripts/validate-prism-breaker.mjs','scripts/validate-the-great-empire.mjs','scripts/validate-shared-controls.mjs','scripts/validate-social-sharing.mjs','scripts/validate-analytics.mjs','scripts/validate-icons.mjs','scripts/validate-pwa-install.mjs','scripts/validate-lazy-images.mjs','scripts/validate-seo-geo.mjs','scripts/validate-leaderboards.mjs','scripts/validate-scoring.mjs','scripts/validate-security.mjs','scripts/validate-partners.mjs','scripts/validate-i18n.mjs']) {
...
console.log('  ✓ Session, Avatar, social sharing, analytics, icons, PWA install, lazy images, Block Drop, Bubble Burst, Neon Snake, Neon Tilt, Solitario, Prism Breaker and The Great Empire specialized validators are green');
