...
must(html.includes('style.css?v=20260902.1') && html.includes('game.js?v=20260902.1'), 'changed Block Drop assets must be explicitly cache-versioned');
...
must(css.includes('aspect-ratio: 1 !important') && css.includes('.rotate { grid-column: 2') && css.includes('.drop { grid-column: 3'), 'Rotate and Drop must remain square and side by side');
