(() => {
  ...
  const BOSSES = [
    ...
    {name:'IRON MANTA', shape:'manta', hp:560, r:55, ai:'dash', attack:'mines', color:'#65e7ff', accent:'#ff795f', speed:1.02, mineCount:2, mineBurstCount:5, mineAimEvery:3, attackDelayScale:1.18, tagline:'HEAVY STRIKE WING'},
  ...
  function getBoss(level){
    ...
    return {
      ...
      attackScale:1+index*.055+cycle*.13,
