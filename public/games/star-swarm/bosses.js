(() => {
  ...
  const BOSSES = [
    ...
    {name:'NOVA QUEEN', shape:'queen', hp:560, r:54, ai:'orbit', attack:'homing', color:'#ff8bdc', accent:'#7cffb2', speed:1.02, tagline:'ROYAL HIVE MIND'},
    {name:'HYDRA GRID', shape:'hydra', hp:720, r:58, ai:'anchor', attack:'triple-turret', color:'#7cffb2', accent:'#ffe66d', speed:1.08, tagline:'THREE-HEAD BARRAGE'},
    {name:'IRON MANTA', shape:'manta', hp:900, r:55, ai:'dash', attack:'mines', color:'#65e7ff', accent:'#ff795f', speed:1.12, attackCadence:.78, tagline:'HEAVY STRIKE WING'},
