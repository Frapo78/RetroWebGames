(() => {
  ...
  home.setAttribute('aria-label', t('core.backToGames'));
  home.innerHTML = `
  ...
  shareToggle.setAttribute('aria-label', t('share.game', { game: gameName }));
  ...
  shareToggle.innerHTML = `
    ...
    <span class="rwg-tool-label">${t('share.label')}</span>`;
  host.appendChild(shareToggle);

  const tray = document.createElement('div');
  tray.className = 'rwg-share-tray';
  tray.hidden = true;
  tray.setAttribute('aria-label', t('share.thisGame'));
  tray.innerHTML = `
    <a class="rwg-share-option" data-network="whatsapp" target="_blank" rel="noopener noreferrer" aria-label="${t('share.whatsapp')}"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12.04 2a9.84 9.84 0 0 0-8.42 14.93L2.05 22l5.2-1.52A9.95 9.95 0 1 0 12.04 2Zm0 17.86a8.02 8.02 0 0 1-4.09-1.12l-.29-.17-3.08.9.92-3-.19-.31a7.9 7.9 0 1 1 6.73 3.7Zm4.4-5.92c-.24-.12-1.43-.7-1.65-.78-.22-.08-.38-.12-.54.12-.16.24-.62.78-.76.94-.14.16-.28.18-.52.06-.24-.12-1.02-.37-1.94-1.19a7.28 7.28 0 0 1-1.34-1.67c-.14-.24-.01-.37.11-.49.11-.11.24-.28.36-.42.12-.14.16-.24.24-.4.08-.16.04-.3-.02-.42-.06-.12-.54-1.3-.74-1.78-.19-.47-.39-.41-.54-.42h-.46c-.16 0-.42.06-.64.3-.22.24-.84.82-.84 2s.86 2.32.98 2.48c.12.16 1.69 2.58 4.1 3.62.57.25 1.02.39 1.37.5.58.18 1.1.16 1.51.1.46-.07 1.43-.58 1.63-1.15.2-.56.2-1.04.14-1.14-.06-.1-.22-.16-.46-.28Z"/></svg></a>
    <a class="rwg-share-option" data-network="facebook" target="_blank" rel="noopener noreferrer" aria-label="${t('share.facebook')}"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M13.7 22v-9h3l.45-3.5H13.7V7.26c0-1.01.28-1.7 1.74-1.7h1.86V2.43c-.32-.04-1.43-.13-2.72-.13-2.7 0-4.55 1.65-4.55 4.68V9.5H7v3.5h3.03v9h3.67Z"/></svg></a>
    <a class="rwg-share-option" data-network="x" target="_blank" rel="noopener noreferrer" aria-label="${t('share.x')}"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M18.9 2H22l-6.77 7.74L23.2 22h-6.24l-4.89-6.39L6.48 22H3.36l7.26-8.3L2.98 2h6.4l4.42 5.84L18.9 2Zm-1.1 17.84h1.72L8.45 4.05H6.6L17.8 19.84Z"/></svg></a>
    <a class="rwg-share-option" data-network="telegram" target="_blank" rel="noopener noreferrer" aria-label="${t('share.telegram')}"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="m21.7 3.2-3.2 15.1c-.24 1.07-.87 1.33-1.76.83l-4.88-3.6-2.35 2.27c-.26.26-.48.48-.98.48l.35-4.97 9.04-8.17c.39-.35-.09-.55-.61-.2L6.14 11.97 1.32 10.46C.27 10.13.25 9.41 1.54 8.9L20.4 1.63c.87-.32 1.64.2 1.3 1.57Z"/></svg></a>
    <button class="rwg-share-option" data-network="more" type="button" aria-label="${t('share.more')}"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2a2 2 0 1 1 0 4 2 2 0 0 1 0-4Zm0 8a2 2 0 1 1 0 4 2 2 0 0 1 0-4Zm0 8a2 2 0 1 1 0 4 2 2 0 0 1 0-4Z"/></svg></button>`;
